...
N = 1000 #4096-1 # Beacuse in C++ file, it added one more point at end for coeffient.  # This also limit the bandwidth. And this is determined by fpga LUT size.
n = 1
N1 = N*n
...
# f0=-28e6#Start Freq
# f1=28e6#End freq
f0 = -10.5e6  # Start Freq
f1 = 10.5e6 # fs/2=1/2*N/T#End freq
k = (f1 - f0) / T
...
y_cx_delay = y_cx #y_cx_delay_1#y_cx # y_cx_delay_1#y_cx#-y_cx_delay_1# y_cx#-y_cx_delay_1#1 * y_cx #+ 1*y_cx_delay_1 + 1*y_cx_delay_2
